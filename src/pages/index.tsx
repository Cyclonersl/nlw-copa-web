      ...
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          <input
            ...
            value={poolTitle} />
          <button type="submit" className="px-6 py-4 rounded bg-yellow-500 text-gray-900 items-center font-bold text-sm uppercase hover:bg-yellow-700">Criar meu bolão</button>
        </form>
